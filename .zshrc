...
plugins=(git  virtualenv zsh-autosuggestions ubuntu cake command-not-found common-aliases encode64 extract git-extras history last-working-dir pip python sudo web-search vscode )
